<template>
  <div>
    <!-- Folder Tabs -->
    <div class="flex flex-wrap gap-x-1 gap-y-0 items-end">
      <button
        v-for="tab in tabs"
        :key="tab"
        class="relative px-4 py-2 text-xs font-semibold transition-all duration-150 rounded-t-lg border border-b-0 whitespace-nowrap"
        :class="activeTab === tab
